...
AStarComponent::AStarComponent(std::weak_ptr<Actor> owner, int drawOrder)
	: GraphBaseComponent(owner, drawOrder)
{
}

void AStarComponent::Construct(Array<Array<std::shared_ptr<SearchTile>>> tiles)
{
	// graphをサイズ分初期化
...
double AStarComponent::ComputeHeuristic(std::weak_ptr<WeightedGraphNode> target) const
{
