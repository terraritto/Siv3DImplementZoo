...
class GBFSComponent : public GraphBaseComponent
{
public:
	GBFSComponent(std::weak_ptr<Actor> owner, int drawOrder = 100);
...
protected:
	...
	std::unordered_map<std::shared_ptr<WeightedGraphNode>, std::shared_ptr<GBFSScratch>> m_nodeMap;
};
