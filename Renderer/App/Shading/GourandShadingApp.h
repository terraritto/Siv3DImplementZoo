...
{
	class GourandShadingApp : public RenderAppBase
	{
	public:
	...
	protected:
		void FillDrawProcess(const Array<std::shared_ptr<GourandVertexOutput>>& tempVertices, const Array<unsigned int>& tempIndices);
	...
	private:
		std::unique_ptr<GourandVertexShader> m_vertexShader;
		std::unique_ptr<GourandPixelShader> m_pixelShader;
	};
}
